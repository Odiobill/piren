function scopePart(label, agents) {
 ...
 */
export function formatSchedulerEffectivePolicy(policy) {
    ...
    if (policy.legacyMasterGate === "gated") {
        lines.push("legacy gate: retired scheduler.enabled key present with a disabled/malformed value; " +
    ...
    lines.push(`agent scope: ${scopePart("inbox_tasks", policy.agentScope.inboxTasks)} ` +
...
//# sourceMappingURL=scheduler-effective-policy.js.map