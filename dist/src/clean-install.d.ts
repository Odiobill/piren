 ...
 */
export declare const REQUIRED_PACKED_ARTIFACTS: readonly ["dist/src/cli.js", "dist/public/index.html", "dist/src/pi-extension.js", "dist/templates/okf/manifest.yml", "dist/templates/baseline/manifest.yml", "dist/templates/baseline/shared/piren-inbox-task-lifecycle/SKILL.md", "docs/getting-started.md"];
