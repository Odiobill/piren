...
export const SERVICE_TRANSPORTS = ["gateway", "telegram", "discord"];
...
export function generateCronEntry(opts) {
    return [
        "# Generated by piren service install. Remove this line to stop auto-start on boot.",
...
export function installPlan(opts) {
    ...
    return {
        ...
        instructions: [
            ...
            "For now, run the transport manually:",
