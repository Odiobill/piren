...
import { buildSeededContent, parseStarterManifest, validateProfileTemplates, } from "./starter-skills.js";
 ...
 */
export async function probeRecognizedVault(deps, vaultRoot) {
    try {
        try {
 ...
 */
export async function loadBaselineAssets(deps, templatesDir) {
 ...
 */
export async function createBaselineSkill(deps, vaultRoot, assets) {
...
//# sourceMappingURL=init-baseline.js.map