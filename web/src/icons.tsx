...
/** Circular refresh arrows for the explicit telemetry Refresh control. */
export function RefreshIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** Re-run arrow for explicit Retry controls (decorative only). */
export function RetryIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** Box-with-down-arrow glyph for the Archive action. */
export function ArchiveIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** Box-with-up-arrow glyph for the Reopen action. */
export function ReopenIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** Full-page/expand glyph for the Vault Explorer full-page action (V1). */
export function ExpandIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** Decorative folder glyph for directory listing entries (V2). */
...
/** Decorative file glyph for document listing entries (V2). */
export function FileIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: dashboard/home glyph for the sidebar Dashboard navigation label. */
export function HomeIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: gear glyph for the sidebar Settings navigation label. */
export function GearIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: clipboard/task glyph for the Assign-task actions. */
export function ClipboardIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: disk/save glyph for the typed Settings form save controls. */
...
/** WUX-A: plus glyph for the disabled composer upload placeholder control. */
export function PlusIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: left chevron for the approval pager's previous action. */
export function ChevronLeftIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: right chevron for the approval pager's next action. */
export function ChevronRightIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: left arrow glyph for the Vault Explorer back-to-listing action. */
export function ArrowLeftIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
...
/** WUX-A: plug glyph for the token Connect action. */
export function PlugIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg
      aria-hidden="true"
      width={size}
