 ...
 */
export function mapSessionTelemetryFacts(stats: RpcSessionStats, state: RpcSessionState): ConversationTelemetryFacts {
  const facts: ConversationTelemetryFacts = { contextState: "no_window" };
