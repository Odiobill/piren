...
Current verification baseline: 84 test files, 857 tests, `npm run typecheck`, `npm run build`, and `npm run smoke` passing. `npm run clean-install:check` should be run after pushing because it fetches the GitHub source.
